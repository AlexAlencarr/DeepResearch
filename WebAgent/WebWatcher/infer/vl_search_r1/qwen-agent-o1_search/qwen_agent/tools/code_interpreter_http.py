...
def code_interpreter_dash(
        ...
        "input": {
            ...
            "plugin_attributes": {
                "header": {
                    ...
                    or "".join(random.choices("0123456789", k=10))
                },
                "payload": {"input": input, "files": files},
            },
        },
    }
    ...
    if response_ori.status_code != 200:
        raise CIServiceError(
            code=str(response_ori.status_code),
